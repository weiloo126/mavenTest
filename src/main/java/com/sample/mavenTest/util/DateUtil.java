...
public final class DateUtil {
     ...
     * 取得N天前的日期
     */
    public static String getNDayBeforDate(Integer n) {
    ...
    /**
     * 获取今天最后时间的时间戳 结束时间yyyy-MM-dd 23:59:59
     *
     * @return
     */
     ...
     * 根据指定时间返回 年和周
     *
     * @param time 返回数组year=int[0] week=year[1]
     * @return
     */
	...
	public static List<Map<String,String>> getTimeList(){
		List<Map<String,String>> resultList=new ArrayList<Map<String,String>>();
		resultList.add(new HashMap<String, String>() {
		    {
		        put("name", "三个月");  
		        put("value", "threemonth");  
		    }
		});
		resultList.add(new HashMap<String, String>() {
		    {
     ...
     * @return 当前日期是星期几
     */
    public static int getMonthOfDate(Date dt) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(dt);
    ...
    * @return str
    */
    public static String DateToStr(Date date,boolean isNeedms) {
    ...
    * @return date
    */
    public static Date StrToDate(String str,boolean isNeedms) {
